...
// Calculate the number of elements in each set + the number of elements in the largest set
...
// Without rank compression, the time complexity explodes; it is too high
