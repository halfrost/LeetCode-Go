...
Given the root node root of a binary search tree, return the minimum difference between the values of any two different nodes in the tree.

## Solution Approach

- This problem is exactly the same as problem 530. See problem 530 for the solution approach.
