...
Merge the given intervals; intervals that overlap should be merged.


## Solution Approach

First sort the intervals by their starting points. Then scan from the interval with the smallest starting point, and merge each overlapping interval in order.
## Code
