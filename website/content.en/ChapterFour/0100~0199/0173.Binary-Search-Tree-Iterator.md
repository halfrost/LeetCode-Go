...
Implement a binary search tree iterator. You will initialize the iterator with the root node of a binary search tree. Calling next() will return the next smallest number in the binary search tree.

## Solution Approach

- Use a priority queue to solve it
