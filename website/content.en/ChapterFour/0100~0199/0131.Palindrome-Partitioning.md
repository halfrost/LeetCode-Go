...
Given a string s, partition s into some substrings so that every substring is a palindrome. Return all possible partitioning schemes of s.

## Solution Ideas

- The problem asks for all solutions in which a string can be split into palindromic strings; use DFS recursion to solve it.
