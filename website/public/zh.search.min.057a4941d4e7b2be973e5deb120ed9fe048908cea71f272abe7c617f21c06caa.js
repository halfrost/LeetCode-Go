...
const target=event.target;if(target&&typeof target.closest==='function'&&target.closest('input, textarea, select, [contenteditable=""], [contenteditable="true"], #gitalk-container, .gt-container')){return;}
const active=document.activeElement;if(active&&(active.tagName==='INPUT'||active.tagName==='TEXTAREA'||active.tagName==='SELECT'||active.isContentEditable)){return;}
...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode/flexsearch.min.js');loadScript('/leetcode/zh.search-data.min.d0d77a4747e93068c8c632be0c1fa853ed2a34004d47429e57c0f958f9aa99c9.js',function(){input.required=false;search();});}
