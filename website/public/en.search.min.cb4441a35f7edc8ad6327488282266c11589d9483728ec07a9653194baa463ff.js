...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode/flexsearch.min.js');loadScript('/leetcode/en.search-data.min.e6589f2e5ab7da3b9eb0bee1547f56f85b01d9cfe3db227ce6aee35ac05e6560.js',function(){input.required=false;search();});}
