...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode/flexsearch.min.js');loadScript('/leetcode/en.search-data.min.6f30ffd5a52eee02f8d139e7b1bd3ff70be3be6e83abf4c7d7e0a681f4d000cd.js',function(){input.required=false;search();});}
